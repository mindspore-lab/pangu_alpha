...
echo "for example:"
echo "bash run_dist_cft_infer.sh /path/hccl.json 4 0"
...
data_path=/store0/pangu_alpha/pf_cft/cft/
output_path=/store0/pangu_alpha/output_pangu/
model_config_path=${LOCAL_PATH}/configs/infer_model_config_pangu_cft.yaml
