...
from src.model import VirtualDatasetOneInputCell, EvalNet_p, PanguAlpha, PanguAlphaConfig
...
def load_model(model_config, is_eval):
    ...
    fake_input = ms.Tensor(np.ones(shape=(1, config.seq_length)), mstype.int32)
    ...
    print("load model and ckpt success!!")
    return model, config
