...
from mindspore.nn import TransformerOpParallelConfig, TransformerRecomputeConfig
...
from src.model import LearningRate, TrainingMonitor, PanguAlpha_BC, PanguAlpha_Model, PanguAlphaConfig, set_parse
...
def finetuning(finetune_config):
    ...
    t_data_ = ProcessData(finetune_config, tokenizer, train=True)
    ...
    e_data_ = ProcessData(finetune_config, tokenizer, train=False)
