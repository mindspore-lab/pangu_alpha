...
def add_training_params(opt):
    ...
    opt.add_argument("--expand_ratio",
                     type=int, default=4,
                     help="expand ratio of input size in Feed-Forward Layer, default is 4.")
    ...
    opt.add_argument("--model_parallel_num",
                     type=int, default=4,
...
def get_args(inference=False):
    ...
    parser.add_argument("--data_path", required=True, default=None, help='Location of data.')
    parser.add_argument("--output_path", required=True, default="", type=str, help='use audio out')
    parser.add_argument("--ckpt_path", default="", type=str, help='eval or infer, model file path')
    parser.add_argument("--pretrained_model_path", default="", type=str, help='finetune, pretrained model file')

    parser.add_argument("--ckpt_name", default="pangu_alpha_2B6_", type=str, help="ckpt file name")
    parser.add_argument("--ckpt_dir", default="ckpt", type=str, help="local ckpt dir")
    parser.add_argument('--position_embedding_name', default="pangu_alpha_2B6_position_embedding.npy", type=str,
                        help="position embedding name, default position_embedding.npy")
    parser.add_argument("--top_query_embedding_name", default="pangu_alpha_2B6_top_query_embedding.npy", type=str,
                        help="top query embedding name, default top_query_embedding.npy")
    parser.add_argument("--word_embedding_name", default="pangu_alpha_2B6_word_embedding.npy", type=str,
                        help="word embedding name, default word_embedding.npy")
    parser.add_argument("--ckpt_strategy_name", default="pangu_alpha_2B6_ckpt_strategy.ckpt", type=str,
                        help="The training parallel strategy for the model.")

    parser.add_argument("--ckpt_name_prefix", default="filerted_", type=str,
                        help="decompressed ckpt file name prefix")
    parser.add_argument("--ckpt_num", default=512, type=int,
                        help="number of pre-trained model ckpt files")

    parser.add_argument("--data_train_name", default="train.json", type=str, help="train data file name")
    parser.add_argument("--data_dev_name", default="dev.json", type=str, help="dev data file name")
    parser.add_argument("--data_test_name", default="test.json", type=str, help="infer input file name")
    parser.add_argument("--id2label_name", default="labels_ch.json", type=str, help="Englist Chinese label data file name")
    parser.add_argument("--data_test_answer_name", default="cloze.test.answer", type=str,
                        help="infer input answers file name")
    parser.add_argument("--test_sample_num", default=1000, type=int,
                        help="samples for infer")

    parser.add_argument("--vocab_model_name", default="vocab.model", type=str,
                        help="vocab model name, default vocab.model")
    parser.add_argument("--vocab_vocab_name", default="vocab.vocab", type=str,
                        help="vocab vocab name, default vocab.vocab")
    parser.add_argument("--per_step_print", default=10000, type=int,
                        help="per step print eval result")
