...
def get_args(inference=False):
    ...
    parser.add_argument('--position_embedding_name', default="position_embedding.npy", type=str,
                        help="position embedding name, default position_embedding.npy")
    parser.add_argument("--top_query_embedding_name", default="top_query_embedding.npy", type=str,
                        help="top query embedding name, default top_query_embedding.npy")
    parser.add_argument("--word_embedding_name", default="word_embedding.npy", type=str,
